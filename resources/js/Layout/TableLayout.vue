            ...
            <div class="flex">
                <div class="relative inline">
                    ...
                    >
                        ...
                        <li class="relative">
                            <hr
                                class="h-px my-2 bg-gradient-to-r from-transparent via-black/40 to-transparent"
                            />
                        </li>
                        <li class="relative">
                            <a
                                class="py-1.2 text-danger lg:ease clear-both block w-full whitespace-nowrap rounded-lg px-4 font-normal text-red-600 transition-colors hover:bg-gray-200 focus:bg-gray-200 dark:hover:bg-gray-200/80 lg:duration-300"
                                href="javascript:;"
                                >Remove Filter</a
                            >
                        </li>
                        ...
                        >
                            <div class="dataTable-top">
                                <div class="dataTable-search">
                                    <input
                                        class="dataTable-input focus:shadow-primary-outline dark:text-white/80 ease focus:outline-none focus:transition-shadow"
                                        placeholder="Search..."
                                        type="text"
                                    />
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="flex items-center">
                                                    <div
                                                        class="min-h-6 pl-7 mb-0.5 block"
                                                    >
                                                        <input
                                            ...
                                            <td class="font-semibold">
                                                <span
                                                    class="my-2 text-xs leading-tight"
                                                    >1 Nov, 10:20 AM</span
                                                >
                                            </td>
                                            <td
                                        ...
                                        <tr>
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    <div
                                                        class="inline-flex items-center justify-center w-6 h-6 mr-2 text-xs text-white transition-all duration-200 ease-in-out rounded-xl bg-gradient-to-tl from-zinc-800 to-zinc-700"
                                                    >
                                                        <span>M</span>
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            >
                                                <div class="flex items-center">
                                                    <div
                                                        class="inline-flex items-center justify-center w-6 h-6 mr-2 text-xs text-white transition-all duration-200 ease-in-out rounded-xl bg-gradient-to-tl from-blue-500 to-violet-500"
                                                    >
                                                        <span>L</span>
                                                    </div>
        ...
        <footer class="pt-4">
            <div class="w-full px-6 mx-auto">
                ...
                >
                    ...
                    >
                        <div
                            class="text-sm leading-normal text-center copyright text-slate-500 lg:text-left"
                        >
                            ©
                            <script>
